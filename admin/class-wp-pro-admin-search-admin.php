 ...
 * @subpackage WP_Pro_Admin_Search/admin
 */
 ...
 */
class WP_Pro_Admin_Search_Admin
{
	...
	public function enqueue_styles()
	{
		 ...
		 * defined in WP_Pro_Admin_Search_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The WP_Pro_Admin_Search_Loader will then create the relationship
